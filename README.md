...
```
perl get_abundance_and_taxonomy_v2.pl --type blastx --smf [sample_name_smf] --r2c [read2classification.txt] --m8 [peptide_alignments.m8] --otu_table [peptide_otu_table.tsv] --max_evalue 100 --min_pident 100 --min_qcov 0 --min_alnlen 7 --min_tcov 0.7 > peptide_abundance_and_taxonomy.txt
```
